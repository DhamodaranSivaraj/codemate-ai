...
class Plan(BaseModel):
    ...
    techstack: str = Field(description="The tech stack is used for the app, e.g. 'python', 'javascript', 'react', 'flask', etc.'")
    featues: list[str] = Field(description="A list of features that the app should have, e.g. 'user authentication', 'data visualization', etc.'")
